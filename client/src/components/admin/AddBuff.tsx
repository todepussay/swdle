...
function AddBuff({ closeModal, updateData }: AddBuffProps){
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        axios.post(`${apiUrl}/admin/buffs/add`, buffInformation, {
            headers: {
            ...
            if(res.data.success){
                setStatus('success');
                toast.success("Effet de renforcement ajouté avec succès");
                updateData();
                setName('');
                setImage(undefined);
                setTimeout(() => {
        ...
        <form className='AddForm'>
            ...
            <div className="row">
                <ImageUpload 
                    ...
                    require
                    name='image'
                    label="Image de l'effet de renforcement"
                    value={image}
            ...
            <div className="submit-btn">
                ...
                <Button status={status} color="success" onClick={handleSubmit}>
                    <IoAddCircleOutline />
                    Ajouter un nouvelle effet de renforcement
                </Button>
            </div>
        </form>
    )
